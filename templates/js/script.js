...
-------------------------------------------*/
    if ($("#clock2").length) {
        function timeElapse(date) {
            ...
            var html = '<div class="box"><div>' + days + '</div> <span>' + $('#clock2').data('text-day') + '</span></div><div class="box"><div>' + hours + '</div> <span>' + $('#clock2').data('text-hour') + '</span> </div><div class="box"><div>' + minutes + '</div> <span>' + $('#clock2').data('text-minute') + '</span> </div><div class="box"><div>' + seconds + '</div> <span>' + $('#clock2').data('text-second') + '</span></div>';
            $('#clock2').html(html);
        }
        var time = $('#clock2').data('date');
        $('#clock2').countdown(time.replace(/-/g, '/'), function (event) {
            if (event.type == 'stoped') {
                var together = new Date($('#clock2').data('date'));
                together.setHours(0);
                together.setMinutes(0);
                together.setSeconds(0);
                together.setMilliseconds(0);
                ...
                var $this = $(this).html(event.strftime(''
                    + '<div class="box"><div>%D</div> <span>' + $('#clock2').data('text-day') + '</span> </div>'
                    + '<div class="box"><div>%H</div> <span>' + $('#clock2').data('text-hour') + '</span> </div>'
                    + '<div class="box"><div>%M</div> <span>' + $('#clock2').data('text-minute') + '</span> </div>'
                    + '<div class="box"><div>%S</div> <span>' + $('#clock2').data('text-second') + '</span> </div>'));
            }
        });
    }
